 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  LEFT  |   1  |   2  |   3  |   4  |   5  | ESCA |           | RIGHT|   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox_pretty(
  // left hand
  KC_LEFT,         KC_1,        KC_2,          KC_3,    KC_4,    KC_5,    KC_ESC,               KC_RGHT,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,              KC_MINS,
  ...
  LT(SYMB,KC_GRV), KC_QUOT,     LALT(KC_LSFT), /*KC_LEFT, KC_RGHT,*/ KC_TRNS, KC_TRNS,                                 KC_TRNS, KC_TRNS, /* KC_UP,        KC_DOWN,*/ KC_LBRC, KC_RBRC, TT(SYMB),
                                                           ALT_T(KC_APP), KC_LGUI,              TG(COLEMAK), CTL_T(KC_ESC),
                                                                          KC_HOME,              KC_PGUP,
